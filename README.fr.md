...
Les composants tiers conservent leurs licences d'origine (LVGL / Peanut-GB / MiniGB APU / cJSON — MIT ; ESP-IDF — Apache 2.0 ; Helix MP3 — RealNetworks RPSL, gratuit pour usage non commercial).
